...
# Tags   : tag-codeforces, tag-problem-C, tag-div-3, tag-difficulty-800
# Notes  : greedy
# ---------------------------------------------------------------------------------------
...
def get_min(numbers, options):
    return min(options[sum(numbers)], int(list_to_string(list(map(str, numbers)))))
...
def load_data():
    ...
    for a1 in range(1, 10):
        ...
        for a2 in range(a1 + 1, 10):
            numbers = [a1, a2]
            options[sum(numbers)] = get_min(numbers, options)
                ...
                for a4 in range(a3 + 1, 10):
                    ...
                    for a5 in range(a4 + 1, 10):
                        ...
                        for a6 in range(a5 + 1, 10):
                            ...
                            for a7 in range(a6 + 1, 10):
                                numbers = [a1, a2, a3, a4, a5, a6, a7]
                                options[sum(numbers)] = get_min(numbers, options)

                                for a8 in range(a7 + 1, 10):
                                    numbers = [a1, a2, a3, a4, a5, a6, a7, a8]
                                    options[sum(numbers)] = get_min(numbers, options)

                                    for a9 in range(a8 + 1, 10):
