...
# Notes  : data structures, implementation, strings
# ---------------------------------------------------------------------------------------
...
def solve():
    ...
    for i in range(n - 1, -1, -1):
        ...
        if letter == "B":
            ...
            if letter.isupper() and count_upper_b != 0:
                count_upper_b -= 1
            elif letter.islower() and count_lower_b != 0:
                count_lower_b -= 1
            else:
                result.append(letter)

    return list_to_string(result[::-1])
